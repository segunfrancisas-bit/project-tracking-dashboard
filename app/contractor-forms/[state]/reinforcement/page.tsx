...
export default function ReinforcementForm() {
...
const state = Array.isArray(stateParam)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (error) alert("Upload failed: " + error.message);
      ...
      setForm({ project: "", contractor: "", tons: "", category: "", dateRequested: "" });
    }
  };

  return (
    <div className="p-6 max-w-xl mx-auto">
      <h1 className="text-2xl font-bold mb-4">Reinforcement Form – {state}</h1>
