  ...
  return (
    <div className="flex flex-col justify-between min-h-screen bg-[#FFFCF5]">
      <div className="flex flex-col items-center justify-center flex-1 p-4">
        ...
        {/* 🔥 WELCOME HEADING ABOVE THE CARD */}
        <h1 className="text-3xl font-bold text-black mb-8 text-center pop-out-text whitespace-nowrap">
          Welcome to Vision - Your #1 Project Tracker
        </h1>

        {/* 🔥 GLASS CARD FOR LOGIN ONLY */}
        <div className="glass-card glass-card-responsive">
          <form onSubmit={handleSubmit} className="flex flex-col justify-center gap-4">
            ...
            <input
              ...
              className="px-4 py-2 rounded-lg text-black focus:outline-none border border-gray-300 bg-white/60 backdrop-blur-sm"
            />
